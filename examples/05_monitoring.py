...
async def main():
    ...
    print(
        f"  🔥 Highest cost use case: {highest_cost[0]} (${highest_cost[1]['cost']:.6f})"
    )
    print(
        f"  📊 Highest volume use case: {highest_volume[0]} ({highest_volume[1]['sessions']} sessions)"
    )
    print("  💰 Consider cheaper models for high-volume, low-complexity tasks")
