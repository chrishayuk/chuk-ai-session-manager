...
class TestPerformanceAndMemory:
    ...
    async def test_concurrent_session_managers(self):
        ...
        tasks = [process_conversation(sm, i) for i, sm in enumerate(managers)]
...
class TestErrorRecoveryAndResilience:
    ...
    async def test_concurrent_modifications(self):
        ...
        # Run concurrently
        await asyncio.gather(add_user_messages(), add_ai_messages())
...
class TestMetadataAndProperties:
    ...
    async def test_comprehensive_metadata(self):
        ...
        metadata = {
            ...
            "priority": "high",
            "tags": ["urgent", "billing"],
            "custom_data": {"department": "sales", "region": "north"},
        }
