...
class TestSessionManagerExceptions:
    ...
    def test_tool_processing_error_with_reason(self):
        ...
        error = ToolProcessingError(tool_name="search", reason="API key invalid")
...
class TestExceptionMessageFormatting:
    ...
    def test_exception_string_representations(self):
        ...
        test_cases = [
            ...
            (
                InvalidSessionOperation(operation="test", reason="because"),
                "Invalid operation 'test': because",
            ),
            (
                TokenLimitExceeded(limit=100, actual=150),
                "Token limit exceeded: 150 > 100",
            ),
